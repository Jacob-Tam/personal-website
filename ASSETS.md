...
| Hyperloop CAD render | `/public/media/hyperloop.webp` | landscape ~16:9 | ✅ live (cropped 16:9, chassis centred) | `Hyperloop.webp` (portrait source → cropped around the chassis) |
