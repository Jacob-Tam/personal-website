...
export const CHOREOGRAPHY = {
  ...
  // Interlude: the orb sweeps right -> left along a sideways-U arc, staying above the text.
  interludeSweepX: 2.2, // horizontal half-span of the sweep (right at start, left at end)
  interludeLiftHigh: 1.8, // y at the U's tips (up high, above the text)
  interludeUDepth: 0.6, // how far it dips at the centre of the U (still above the text)
