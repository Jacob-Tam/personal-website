/*
  ...
  under /public/media and are used once MEDIA_READY (lib/assets.ts) is true; until then the
  cards render placeholder posters. See ASSETS.md for the real-file mapping.
*/
...
export const PROJECTS: Project[] = [
  {
    ...
    media: { kind: 'video', src: '/media/smartbox.mp4', alt: 'Anti-Theft Package Smartbox demo' },
  },
  {
    id: 'taxi',
    ...
    media: { kind: 'video', src: '/media/taxi.mp4', alt: 'Autonomous robot taxi driving demo' },
  },
  {
    id: 'hyperloop',
    ...
    media: { kind: 'image', src: '/media/hyperloop.webp', alt: 'Hyperloop pod suspension CAD render' },
  },
  {
    id: 'qhdt',
    ...
    media: { kind: 'video', src: '/media/qhdt.mp4', alt: 'QHDT team platform walkthrough' },
  },
]
